...
$count = get_rows('admin', ' 1 ');
$page_size = 10;
$page = empty($_GET['page']) ? 1 : $_GET['page'];
$page = !is_numeric($page) ? 1 : $page;
$pages = ceil($count / $page_size);
$offset = ($page - 1) * $page_size;
$list = getList('admin', ' 1 ', $page_size, $offset);
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>管理员管理 - News Platform</title>
      ...
      <ul class="layui-nav layui-nav-tree" lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a href="user.php" class="layui-this"><i class="fas fa-user-shield"></i> 管理员列表</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
  ...
  <div class="layui-body custom-body">
    <div class="content-card">
      <div class="card-header">
        <h3><i class="fas fa-user-shield"></i> 管理员列表</h3>
        <a href="log/reg.php" class="btn-primary">
      ...
      <div class="card-body">
            ...
            <tbody>
              ...
              <?php else: ?>
                ...
                <tr>
                  ...
                  <td>
                    <div class="user-cell">
                      <div class="user-avatar"><?php echo mb_substr($value['name'], 0, 1); ?></div>
                      <span><?php echo htmlspecialchars($value['name']); ?></span>
                    </div>
                  </td>
                  <td><?php echo htmlspecialchars($value['uid']); ?></td>
                  ...
                  <td>
                    <div class="action-buttons">
                      <a href="profile.php?id=<?php echo $value['id']; ?>" class="btn-icon btn-edit" title="编辑">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a href="xiugai.php?id=<?php echo $value['id']; ?>" class="btn-icon btn-secondary" title="修改密码">
        ...
        <div class="pagination-wrapper">
          ...
          <div class="pagination">
            <a href="user.php?page=1" class="page-link <?php echo $page <= 1 ? 'disabled' : ''; ?>">
              <i class="fas fa-angle-double-left"></i>
            </a>
            <a href="user.php?page=<?php echo max(1, $page-1); ?>" class="page-link <?php echo $page <= 1 ? 'disabled' : ''; ?>">
              <i class="fas fa-angle-left"></i>
            </a>
            <span class="page-current"><?php echo $page; ?></span>
            <a href="user.php?page=<?php echo min($pages, $page+1); ?>" class="page-link <?php echo $page >= $pages ? 'disabled' : ''; ?>">
              <i class="fas fa-angle-right"></i>
            </a>
            <a href="user.php?page=<?php echo $pages; ?>" class="page-link <?php echo $page >= $pages ? 'disabled' : ''; ?>">
